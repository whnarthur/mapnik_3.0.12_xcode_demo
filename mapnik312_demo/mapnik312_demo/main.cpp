...
int main(int, char**) {
    using namespace mapnik;
    datasource_cache::instance().register_datasources("./input/");
//    freetype_engine::register_font("/usr/local/Cellar/mapnik/3.0.12_3/lib/mapnik/fonts");
    
    Map m(800, 600);
    
    mapnik::load_map(m, "./mapxml/map_world.xml", true);
